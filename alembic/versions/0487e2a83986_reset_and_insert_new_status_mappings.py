"""reset and insert new status mappings

Revision ID: 0487e2a83986
Revises: 99035e5a8b7c
Create Date: 2025-09-10 18:51:23.457982
...
revision: str = '0487e2a83986'
down_revision: Union[str, Sequence[str], None] = '99035e5a8b7c'
branch_labels: Union[str, Sequence[str], None] = None
depends_on: Union[str, Sequence[str], None] = None


inventory_status_mapping = table(
